...
#define USBD_PID                      0x484  /* Replace '0xaaaa' with your device product ID */
#define USBD_LANGID_STRING            0x1409   /* Replace '0xbbb' with your device language ID */
...
static void Get_SerialNum(void)
{
  ...
  // placeholder serial number due to hardfault being triggered when trying to access unique ID registers on STM32H5. Replace with actual unique ID retrieval code if needed.
  uint32_t deviceserial0 = 0x12345678U;
  uint32_t deviceserial1 = 0x9ABCU;
