...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, DISPLAY_DC_Pin|LED_HUMDIFIER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DISPLAY_RST_GPIO_Port, DISPLAY_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED_WATER_Pin|BUTTON_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DISPLAY_DC_Pin LED_HUMDIFIER_Pin */
  GPIO_InitStruct.Pin = DISPLAY_DC_Pin|LED_HUMDIFIER_Pin;
  ...
  /*Configure GPIO pins : LED_WATER_Pin BUTTON_1_Pin */
  GPIO_InitStruct.Pin = LED_WATER_Pin|BUTTON_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : BUTTON_2_Pin ENCODER_BUTTON_Pin */
  GPIO_InitStruct.Pin = BUTTON_2_Pin|ENCODER_BUTTON_Pin;
